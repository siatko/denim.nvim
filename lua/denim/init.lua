...
function M.setup(opts)
  ...
  if keymaps then
    ...
    if keymaps.daily_note then
      vim.keymap.set("n", keymaps.daily_note, function()
        require("denim.calendar").open()
      end, { desc = "denim: open daily note calendar" })
    end
  ...
  vim.api.nvim_create_user_command("DenimDaily", function()
    require("denim.notes").daily_note()
  end, { desc = "Open or create today's daily note" })
  vim.api.nvim_create_user_command("DenimCalendar", function()
    require("denim.calendar").open()
  end, { desc = "Pick a day and open or create its daily note" })
